...
class Annonce
{
    ...
    // Constructor
    public function __construct($titre = null, $description = null, $couverture = null, $status = null, $id_conducteur = null)
    {
        $this->pdo = Database::getInstance();
        if ($titre !== null && $description !== null && $couverture !== null && $status !== null && $id_conducteur !== null) {
            $this->titre = $titre;
    ...
    public function getListAnnoncesAdmin()
    {
